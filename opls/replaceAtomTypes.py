...
if __name__ == '__main__':
    ...
    renameRTF(str(sys.argv[1]) + '.charmm.rtf',atMapping,outFile=str(sys.argv[1]) +'.rtf')
    renamePRM(str(sys.argv[1]) +'.charmm.prm',atMapping,outFile=str(sys.argv[1]) +'.prm',duplicates=False)
