...
sed s/HETATM/ATOM"  "/g tmp.pdb | convpdb.pl -segnames -setchain A | sed s/PRO[0-9A-Z]/LIG/g | \
	sed s/UNL/LIG/g > tmpligand.pdb 

num=`grep ATOM ligand/bg126.rtf | sed /LPH/d | wc -l | awk '{print $1}'`
grep ATOM ligand/bg126.rtf | sed /LPH/d | awk '{print $2}' > tmplist
...
convpdb.pl -segnames -setchain A tmpligand.pdb | sed s/PRO[0-9A-Z]/LIG/g > conformer/${1}.pdb
